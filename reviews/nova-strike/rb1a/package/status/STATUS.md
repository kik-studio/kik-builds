# Nova Strike · Review Build 1a — status matrix

**Build `0.1.0+473bb47`** · Builder-reported, 2026-09-25. Same as Review Build 1 except the rows marked *changed*. Each row names its evidence. Status values: **complete** · **partial** · **not done** · **regressed** · **new issue**.
...
| Sound in browsers | complete (Chromium) · pending (iPhone Safari) — *changed* | measured: sound reaches the speakers (tests/AUDIO_BROWSER.md); test_runner audio checks 3/3 |
...
## Changes from Review Build 1
Fixed: browser silence. Nothing regressed that the re-run tests show (test_runner 50/0, combat_tests 35/0, qa_suite 174/0, ui_tests 0 failures).
